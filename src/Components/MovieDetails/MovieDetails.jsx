...
import { GetDetailsMovies } from '../../Store/detailsMovies'
...
export default function MovieDetails() {
  ...
  async function getData(value){
    setloding(true)
    let respons=await dispatch(GetDetailsMovies(value))
...
// eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  <div className=' container my-5'>
    ...
    {data?data.map((e,i)=> <div key={e.id} className='row'>
      ...
      <span className='my-4'>{e.original_title}</span>
      ...
      <h6 className='my-4'>Release date : {e.release_date}</h6>
